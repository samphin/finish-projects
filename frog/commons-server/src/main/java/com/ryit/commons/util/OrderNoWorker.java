...
public class OrderNoWorker {
    ...
    private static long getRandom(long n) {
        ...
        long rangeInteger = (((long) (new Random().nextDouble() * (max - min)))) + min;
        return rangeInteger;
    }
    ...
    private static synchronized String getCode(Integer userId) {
        ...
        return getTimestamps() + toCode(userId);
    }
     ...
     */
    public static String generateReturnCode(Integer userId) {
     ...
     */
    public static String generateRefundCode(Integer userId) {
     ...
     */
    public static String generateAgainCode(Integer userId) {
        return AGAIN_ORDER + getCode(userId);
    }

    public static void main(String[] args) {
        System.out.println(generateOrderNo(530));
    }
}
