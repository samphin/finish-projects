package com.ryit.walletwebgateway.shiro;
...
//        }
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken auth) throws AuthenticationException {
        ...
        if (JwtUtil.verify(token) && redisUtil.hasKey(String.format(RedisConstants.PREFIX_WALLET_WEB_REFRESH_TOKEN, account))) {
            // 获取RefreshToken的时间戳
            String currentTimeMillisRedis = redisUtil.get(String.format(RedisConstants.PREFIX_WALLET_WEB_REFRESH_TOKEN, account));
