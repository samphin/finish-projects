...
public class Global
{
    ...
    {
        return StringUtil.nvl(getConfig("ryit.name"), "ryit");
    }
    ...
    {
        return StringUtil.nvl(getConfig("ryit.version"), "1.0.0");
    }
    ...
    {
        return StringUtil.nvl(getConfig("ryit.copyrightYear"), "2019");
    }
